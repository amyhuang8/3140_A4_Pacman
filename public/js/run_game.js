...
Description: This JavaScript file contains functions for manipulating the run_game.php file.
*/
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            leaderboardArray.forEach(score => {
                ...
                li.textContent = `${score.username}: ${score.highscore}`; //updating text content with "name: score"
                leaderboardList.appendChild(li); //appending to list
